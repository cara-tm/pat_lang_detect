...
Redirections can be a problem and/or noticed as a bad practice by performance tools. The default "@redirect@" attribute is set to "@false@" and you could prefer to display a simple locale message for your visitors instead:

bq. &lt;txp:pat_lang_detect /&gt;
&lt;txp:if_variable name="visitor_lang" value="en"&gt;
    &lt;p&gt;This website is also available in your language: &lt;a href="&lt;txp:pat_lang_detect display="1" /&gt;"&gt;here&lt;/a&gt;&lt;/p&gt;
&lt;/txp:if_variable&gt;
