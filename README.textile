...
Note: @x-default@ value if a section is found same as the website default active language sets in the languages préférences. Best place to add in your "Default" page template. Just because this plugin can't find all corresponding translated sections of your website from yo. Nevermind, Google will understand your website structure from your home page. If you want a in deep SEO organisation, you will need to create a conditional individual article loop maybe with the help of a @custom_field@ to store the @#ID@ identifer of the corresponding translated article in order to generate manualy an alternate href link.
