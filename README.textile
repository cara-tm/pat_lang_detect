...
Place this tag into your @<head>@ part of your HTML document:

bq. &lt;txp:pat_lang_meta_href /&gt;

This tag checks all your locale sections available (named by 2 letters in ISO2 format) and injects all alternate links accordingly, e.g.:
...
Note: @x-default@ value if a *default section* is found same as the website default @active language@ sets in the languages préférences.
